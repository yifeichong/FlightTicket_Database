...
urlpatterns = [
    ...
    url(r'^user_operation/$', views.user_operation, name='user_operation'),  # 用户信息
    url(r'^user_bill/$', views.user_bill, name='user_bill'),  # 用户账单
    ...
    url(r'^fetch/flight/(?P<flight_id>[0-9]+)/$', views.fetch_ticket, name='fetch_ticket'),  # 取票
    url(r'^pay/flight/(?P<flight_id>[0-9]+)/$', views.pay_ticket, name='pay_ticket'),  # 付款
]
